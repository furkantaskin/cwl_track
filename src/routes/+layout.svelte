...
<nav class="bg-white border-gray-200 dark:bg-gray-800 fixed top-0 left-0 right-0 ">
	<div class="max-w-screen-xl flex flex-wrap items-center justify-center mx-auto p-8">
		...
		<div class="hidden w-full md:block md:w-auto" id="navbar-default">
			<ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-800 dark:border-gray-700">
				<li>
					<a href="#" class="navbar-item">Müşteriler</a>
				</li>
				<li>
					<a href="/services" class="navbar-item">Hizmetler</a>
				</li>
			</ul>
		</div>
	</div>
...
<main class="bg-white dark:bg-gray-800 dark:border-gray-700">
	<slot>
		<h1>404</h1>
		<p>Page not found</p>
	</slot>
